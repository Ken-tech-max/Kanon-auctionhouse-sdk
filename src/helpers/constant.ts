export const KANON_GLOBAL_SEED = "SYNESIS_KANON";
export const KANON_GLOBAL_SEASON_SEED = "SEASON";

export const COLLECTION_STATE_PREFIX = "collection_state";
export const COLLECTION_AUTHORITY_PREFIX = "collection_authority";
export const USER_MINT_RESERVE_STATE_PREFIX = "user_mint_reserve_state";
export const ADMIN_TREASURY_ACCOUNT_PREFIX = "admin_treasury_account";

export const GLOBAL_STATE_ACCOUNT_KEY_DEVNET = "knGbvYZWpbCch6LUP37NdPubmZHGwtZSy9PTwALj854";
export const GLOBAL_STATE_ACCOUNT_KEY_MAINNET = "KNGB5XoZFBDT9vQSDRmGzgvdyWCnCrofn9F88mJtPt5";
